    ...
    <div className="flex min-h-screen bg-[#0b0f14] text-slate-100">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 overflow-auto px-6 py-8 md:px-8">
          <div className="mx-auto grid max-w-7xl gap-6 xl:grid-cols-[minmax(0,1.15fr)_22rem]">
            <section className="rounded-[28px] border border-white/8 bg-[#171b22] p-6 shadow-[0_24px_80px_rgba(5,10,20,0.35)]">
              <div className="mb-8">
                <p className="text-[11px] font-bold uppercase tracking-[0.32em] text-[#2a6ef5]">
                  New Workspace
                </p>
                ...
                <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-400">
                  분석, 알림, 리포트, 권고는 모두 active project 기준으로 묶입니다. 프로젝트를 새로
                  만들면 현재 계정이 관리자 권한으로 바로 연결되고, 생성 직후 해당 프로젝트로 전환됩니다.
                </p>
              </div>
              ...
              <form className="grid gap-6" onSubmit={onSubmit}>
                <div className="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(16rem,0.9fr)]">
                  <label className="grid gap-2">
                    ...
                    <input
                      ...
                      className="h-14 rounded-2xl border border-white/10 bg-[#0f1319] px-4 text-base text-white outline-none transition placeholder:text-slate-500 focus:border-[#2a6ef5]/60 focus:ring-2 focus:ring-[#2a6ef5]/15"
                    />
                  ...
                  <label className="grid gap-2">
                    ...
                    <select
                      ...
                      className="h-14 rounded-2xl border border-white/10 bg-[#0f1319] px-4 text-base text-white outline-none transition focus:border-[#2a6ef5]/60 focus:ring-2 focus:ring-[#2a6ef5]/15"
                    >
                  ...
                  <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-sm text-slate-400">
                        생성 후 이 프로젝트가 active project가 되고, 대시보드와 AI 최적화 화면이 이 기준으로
                        갱신됩니다.
                      </p>
                    </div>

                    <div className="min-w-[15rem] rounded-2xl border border-[#2a6ef5]/20 bg-[#2a6ef5]/10 px-4 py-4">
                      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#8fb5ff]">
                        생성 후 바로 할 일
                      </p>
                      <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-200">
                        <li>1. 연동 메뉴에서 AWS / K8s / Prometheus 연결</li>
                        <li>2. 비용 분석 실행</li>
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 border-t border-white/8 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="rounded-2xl bg-[#2a6ef5] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#4a83ff] disabled:cursor-not-allowed disabled:opacity-60"
                  >
            ...
            <aside className="rounded-[28px] border border-white/8 bg-[#131720] p-6 shadow-[0_24px_80px_rgba(5,10,20,0.28)]">
              <p className="text-[11px] font-bold uppercase tracking-[0.28em] text-slate-500">
                Guide
              </p>
              ...
              <div className="mt-6 space-y-4">
                {[
                  ...
                  <div key={item.title} className="rounded-2xl border border-white/8 bg-[#0f1319] p-4">
